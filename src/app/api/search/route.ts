...
const STATIC_PAGES: SearchResult[] = [
  ...
  { title: "Asset Management", url: "/assets-spares-automation", description: "Live asset registry with lifecycle alerts, AMC tracking, and warranty expiry notifications." },
  { title: "Complaint Management", url: "/complaint-helpdesk-automation", description: "QR-based ticket raising from any location, assigned and tracked with a full audit trail." },
