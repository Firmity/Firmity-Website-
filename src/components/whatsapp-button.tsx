    ...
    <div className="fixed inset-x-0 bottom-5 z-40 pointer-events-none">
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 flex justify-end">
        <Link
          ...
          // (2026-09-04, per request: "make the... whatsapp semi-transparent
          // when they are not in focus or hovered") — transition-transform →
          // transition-all so opacity animates smoothly alongside the
          // existing hover-scale/shadow.
          className="pointer-events-auto flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-[0_8px_32px_rgba(37,211,102,0.35)] opacity-60 hover:opacity-100 focus-visible:opacity-100 transition-all duration-200 hover:scale-[1.06] hover:shadow-[0_12px_40px_rgba(37,211,102,0.45)]"
        >
