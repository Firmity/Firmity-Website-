...
export function WhatsAppButton() {
  ...
  return (
    <Link
      ...
      className="fixed bottom-5 right-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_8px_32px_rgba(37,211,102,0.35)] transition-transform duration-200 hover:scale-[1.06] hover:shadow-[0_12px_40px_rgba(37,211,102,0.45)]"
    >
